// Reference: https://github.com/dblsai/WebGL-Fluid
...
var pool = {};    // cube without top plane
var sky = {};     // cube
var water = {};   // plane
var quad = {};
var sphere = {};
...
window.onload = function () {
    ...
    gui.add(parameters, 'Object', ['sphere']);
...
// can manage them yourself to change the output effect
...
function initSkyBoxTexture() {
    ...
    var urls = [
        ...
        "img/skybox/up.jpg", "img/skybox/down.jpg",
...
function startInteraction(x, y) {
    ...
    else {// mouse direction interaction
...
function drawScene() {
    ...
    if (parameters.Pool_Pattern == "marble" && currentPoolPattern != "marble") {
        initTexture(pool.Texture, "img/tile/tile2.jpg");
        currentPoolPattern = "marble";
    }
    if (parameters.Pool_Pattern == "white brick" && currentPoolPattern != "white brick") {
        initTexture(pool.Texture, "img/tile/tile3.jpg");
        currentPoolPattern = "white brick";
    }
    if (parameters.Pool_Pattern == "blue brick" && currentPoolPattern != "blue brick") {
        initTexture(pool.Texture, "img/tile/tile4.jpg");
        currentPoolPattern = "blue brick";
    }
    if (parameters.Pool_Pattern == "red brick" && currentPoolPattern != "red brick") {
        initTexture(pool.Texture, "img/tile/tile5.jpg");
    ...
    if (parameters.Rain == true) {
        if (rainCounter % 30 == 0) {
            ...
            for (var i = 0; i < num; i++) {
                ...
                var strength = Math.random() * 0.04 - 0.01;
